...
async function printRTF(produtos, total, nPrint) {
  ...
  const imageHexData = convertImageToHex(imagePath);
  ...
  const rtfTemplate = `{\\rtf1\\ansi\\ansicpg1252\\cocoartf2761
    ...
    \\f0\\fs24 \\cf0
    {\\pict\\jpegblip\\picwgoal1000\\pichgoal1000 ${imageHexData}} 						
    \\f1\\b\\fs36  
    \\fs22 Comiss\\'e3o de Festas de Felgueiras 2024\\b0\\par
    ____________________________________\\par
    ${produtosString}
    \\b\\fs32 TOTAL: ${total.toFixed(2)}\\b0\\fs22\\par
    \\f1\\par
  }`;
...
function convertImageToHex(imagePath) {
